...
- go back and add sign/verify to my payloads ( i need a break from the encryption stuff..)
## Accomplishments
...
- Adding stuff like material UI will speed up personal projects very quickly but I could imagine a lot of debt would come with adding something like material ui in a proper project.

## Next Steps
- Websocket / aes encryption
- Cleanup, frontend and backend.

## Conclusion
 - Slow concentration and effort > High pace bursts. 
 - Working on improving my schedule to be able to fit more time for things.